...
class _PlusState extends State<Plus> {
  ...
  void initState() {
    ...
    if (widget.moneyModel != null) {
      BlocProvider.of<FinanceCubit>(context).titleControl.text =
          widget.moneyModel!.title;
      BlocProvider.of<FinanceCubit>(context).number =
          widget.moneyModel!.moneyValue.toString();
    }
  }
  ...
  Widget build(BuildContext context) {
     ...
     */
                              ...
                              child: Padding(
                                padding: const EdgeInsets.all(15.0),
                                child: Text(
                                  widget.moneyModel != null ? 'Save' : ' Done ',
                                  style: TextStyle(
                                      color: AppColors.Black,
                                      fontSize: 18,
